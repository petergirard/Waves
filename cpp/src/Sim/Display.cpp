...
void Display::getStateDisplay(std::ostringstream &oss, const PhysicalState &state) {
    ...
    oss << "Velocity (Pilot Frame): (" << std::setw(6) << state.velocityVehicleFrame.x << ", " << std::setw(6) << state.velocityVehicleFrame.y << ", " << std::setw(6) << state.velocityVehicleFrame.z << ") m/s\n";
    oss << "Acceleration (Pilot Frame): (" << std::setw(6) << state.accelerationVehicleFrame.x << ", " << std::setw(6) << state.accelerationVehicleFrame.y << ", " << std::setw(6) << state.accelerationVehicleFrame.z << ") m/s^2\n";
